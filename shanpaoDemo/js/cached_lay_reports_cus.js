...
(function(){function r(a,b){var c;a||(a={});for(c in b)a[c]=b[c];return a}function w(){var a,b=arguments,c,d={},e=function(a,b){var c,d;typeof a!=="object"&&(a={});for(d in b)b.hasOwnProperty(d)&&(c=b[d],a[d]=c&&typeof c==="object"&&Object.prototype.toString.call(c)!=="[object Array]"&&d!=="renderTo"&&typeof c.nodeType!=="number"?e(a[d]||{},c):b[d]);return a};b[0]===!0&&(d=b[1],b=Array.prototype.slice.call(b,2));c=b.length;for(a=0;a<c;a++)d=e(d,b[a]);return d}function y(a,b){return parseInt(a,b||
    ...
    (f?c?"left":"right":"center"),verticalAlign:b.verticalAlign||(f?"middle":c?"bottom":"top"),y:p(b.y,f?4:c?14:-6),x:p(b.x,f?c?-6:6:0)};this.textAlign=b.textAlign||(f?c?"right":"left":"center")}var u,x=document,G=window,V=Math,v=V.round,U=V.floor,La=V.ceil,t=V.max,L=V.min,Q=V.abs,aa=V.cos,fa=V.sin,oa=V.PI,Ea=oa*2/360,wa=navigator.userAgent,Hb=G.opera,Aa=/msie/i.test(wa)&&!Hb,hb=x.documentMode===8,tb=/AppleWebKit/.test(wa),Ua=/Firefox/.test(wa),Ib=/(Mobile|Android|Windows Phone)/.test(wa),xa="http://www.w3.org/2000/svg",
        ...
        symbols:["circle","diamond","square","triangle","triangle-down"],lang:{loading:"Loading...",months:"January,February,March,April,May,June,July,August,September,October,November,December".split(","),shortMonths:"Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(","),weekdays:"Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday".split(","),decimalPoint:".",numericSymbols:"k,M,G,T,P,E".split(","),resetZoom:"Reset zoom",resetZoomTitle:"Reset zoom level 1:1",thousandsSep:","},global:{useUTC:!0,
            ...
            day:"%A, %b %e, %Y",week:"Week from %A, %b %e, %Y",month:"%B %Y",year:"%Y"},headerFormat:'<span style="font-size: 10px">{point.key}</span><br/>',pointFormat:'<span style="color:{series.color}">芒鈥斅�</span> {series.name}: <b>{point.y}</b><br/>',shadow:!0,snap:Ib?25:10,style:{color:"#333333",cursor:"default",fontSize:"12px",padding:"8px",whiteSpace:"nowrap"}},credits:{enabled:!0,text:"Highcharts.com",href:"http://www.highcharts.com",position:{align:"right",x:-10,verticalAlign:"bottom",y:-5},style:{cursor:"pointer",
        ...
        */
        GetDate : function(d1,d2){
            ...
            switch(len){
                ...
                case 2 :
                    // add by chenjincai
                    // ç”¨æˆ·ç¾¤ï¼Œè§‚å¯Ÿæ—¶é—´ç”¨äºŽèŽ·å–ä»Šå¤©ä¹‹åŽçš„æ—¶é—´ä½¿ç”¨
            ...
            // å…è®¸numå¤§äºŽ0ï¼Œnum ä¸º 0 æ˜¯å½“å¤©ï¼Œ1æ˜¯æ˜Žå¤©ï¼Œ-1æ˜¯æ˜¨å¤©
...
$(document).on('click',function(e){
    if($(e.target).parents('.ui-datepicker-header').length < 1 && $(e.target).parents('.ui-datepicker-calendar').length < 1){
        window.hidePopFrame();
    }
});
/*
...
function stopBubble(e) {
    //å¦‚æžœæä¾›äº†äº‹ä»¶å¯¹è±¡ï¼Œåˆ™è¿™æ˜¯ä¸€ä¸ªéžIEæµè§ˆå™¨
    if( e && e.stopPropagation ){
        //å› æ­¤å®ƒæ”¯æŒW3Cçš„stopPropagation()æ–¹æ³•
        e.stopPropagation();
    }else{
...
$(document).ready(function(){
    ...
    */
    ...
    //track user login
    try{
        var getAppid = cookie_get('umplusappid');
        var usrname = cookie_get('umengplus_name');
        if(getAppid != undefined && usrname != undefined){
            dplus.register({'æ˜¯å¦ç™»å½•': true, 'USER': usrname});
        }else{
            dplus.register({'æ˜¯å¦ç™»å½•': false});
        }
        Log(getAppid,usrname)
    }catch(e){}
})
/*
*ShowSummary
...
function Log(){
    if(location.hostname != 'mobile.umeng.com'){
        console.log(arguments);
    }
}
function _Dplus_track_userEvent(categories,actions,value){
    try{
        var app_id = '';
        var a ={};
        a[actions] = value;
        if($('#app_ids').length > 0){
            a['APPKEY'] = $('#app_ids').attr('attr-id');
        }
        dplus.track(categories,a);
        Log(categories,actions,value);
    }catch(e){
...
function _track_components_usage(){
    try{
        var filter_label = (global.filter.version === '' ? '' : 'ç‰ˆæœ¬ ') + (global.filter.channel === '' ? '' : 'æ¸ é“ ') + (global.filter.segment === '' ? '' : 'ç”¨æˆ·ç¾¤');
        var date_length = $.GetDate(global.pickedStartDay, global.pickedEndDay);
        if( window._gat != undefined){
            if( filter_label != '' ){
                _gaq.push(['_trackEvent','ç»„ä»¶', 'è¿‡æ»¤å™¨', filter_label] );
            }
            _gaq.push(['_trackEvent','ç»„ä»¶', 'æ—¶é—´é€‰æ‹©', 'å¤©æ•°', date_length] );
        }

    }catch(e){}
};
function _Dplus_track_nav_bar(dplusCate, text){
    try{
        var app_id = '';
        var a = {};
        a[dplusCate] = text;
        ...
        dplus.track('æŸ¥çœ‹æŠ¥è¡¨',a);
        Log(dplusCate, text);

    }catch(e){}
};
function _track_nav_bar(gaCate,label){
    try{
        _gaq.push(['_trackEvent','å¯¼èˆª', gaCate, label]);
    }catch(e){}
};
function _track_tab(category, label){
    try{
        _gaq.push(['_trackEvent','å¯¼èˆª', category, label]);
    }catch(e){}
};
    ...
    this.submits = function(inst,settings){
        settings.panel.delegate('a.submit','click',function(){
            if(inst.data('checked') != undefined){
                ...
                var page = '';
                if($('#siderNav .current-item').has('.sub-list').length > 0){
                    page = $('#siderNav li a.current-item').text().trim()
                }else{
                    page = $('#siderNav .current-item a').text().trim();
                }

                _Dplus_track_userEvent('ç­›é€‰æƒ…å†µ', settings.text + 'ç­›é€‰', page);
    ...
    $.fn.ProSelect = function(options) {
        if (this.length > 0) {
            ...
            var defaults = {
                ...
                custom: true,
                callback: '',
                minDate: null, // add by chenjincai æˆ‘çš„äº§å“-->åº”ç”¨è¶‹åŠ¿é€‰æ‹©æŽ§ä»¶æœ‰ç”¨ï¼Œç¦æ­¢é€‰æ‹©8.1, ä¹‹å‰çš„æ—¥æœŸï¼Œä¼ é€’çš„æ˜¯Date Object, ç„¶åŽä¼ ç»™datepickerä½¿ç”¨
                maxDate: +0 // add by chenjincai ä»…æ”¯æŒæ•°å­—ï¼Œç”¨äºŽè®¾ç½®æœ€å¤§å¯ä»¥é€‰æ‹©çš„æ—¥æœŸ
            };
                    ...
                    $('#' + set.tempid).find('li').each(function() {
                        $(this).live('click', function() {
                            ...
                            if ($(this).attr('set-value')!='') {
                                ...
                                var label = window.global.pickedDays + 'å¤©';
                                $t.set.callback(days,window.global.pickedDays,$(this));

                                _track_userEvent('æ–°åŠŸèƒ½ç›‘æµ‹_æ—¶é—´é€‰æ‹©æŽ§ä»¶', 'ç‚¹å‡»', label);
                                _Dplus_track_userEvent('æ—¶æ®µé€‰æ‹©', 'æ—¶æ®µé€‰æ‹©é•¿åº¦', label);
                            } else {
...
;(function($){
    var moudle_func = {
        init : function(options) {
            ...
            //é»˜è®¤typeç»‘å®šclass.eachå‡½æ•°ä¸­çš„$(this)æŒ‡çš„æ˜¯è°ƒç”¨initçš„å¯¹è±¡ï¼Œifå†…éƒ¨çš„$(this)æŒ‡çš„æ˜¯$(this).children()åˆ—è¡¨ä¸­çš„é¡¹
    ...
    this.bindSubmit = function(settings){
        settings.panel.find('.submit').unbind('click').bind('click',function(){
            ...
            if(global.pickedEndDay != ''){
                ...
                _track_userEvent('æ–°åŠŸèƒ½ç›‘æµ‹_æ—¶æ®µå¯¹æ¯”', num + 'å¤©', num);
            }
    ...
    return this.each(function() {
        ...
        function drawLinks() {
            ...
            if(opts.showCustomPage){
                ...
                ï¼š<div class="per-page js-select"><div class="selected" val="'+ perPage +'">'+ perPage +'<b class="select-corner"></b></div>\
                ...
                var _copyTop = $('#productInlineFooter').offset().top;
...
$.fn.DownList = function(options){
    ...
    //inputèŽ·å–ç„¦ç‚¹æ—¶ï¼Œå±•ç¤ºæ‰€æœ‰æ•°æ®
                ...
                success: function(res){
                    ...
                    if( res == "" ) {
                        ...
                        for(i in s){
                            ...
                            else if(platform == 'tvbox'){
                                platform_name = 'TV Box';
                                platform_pic_name = 'tvbox-small';
                            }
                            else if(platform == 'h5app'){
                                platform_name = 'HTML5';
                                platform_pic_name = 'h5app-small';
                            }
                            else if(platform == 'h5'){
                                platform_name = 'H5';
                                platform_pic_name = 'h5-small';
                            }
                            else if(platform == 'pc'){
                                platform_name = 'PC';
                                platform_pic_name = 'pc-small';
                            }
                            else{
...
//                },
        ...
        _renderSeries: function(results){
            var chartId = this.element.attr('id'),
                series = [],
                categories = results.dates || results.categories,
                that = this,
                serie = results.stats,
...
$.fn._export = function(e,options){
    ...
    function getCsv(tar){
        ...
        var tableTitle = $(tar.target).parents('.mod-header').find('h2').text() || $(tar.target).parents('.ui-dialog-title').text();
        _Dplus_track_userEvent('æŠ¥è¡¨å¯¼å‡º', 'æŠ¥è¡¨åç§°', page + '-' + tableTitle);
    ...
    function callbackFunc(e,data,params){
        ...
        if(data.result == 'success'){
            inst.removeClass('export-icon-load');
            inst.after('<div class="tip-export"><div class="small-corner"></div><a class="fr close font-highlight"><b class="icon icon-close"></b></a>'+I18n.t('page_misc.download_center.redirect_link', {'aleft':'<a href='+ params.downloadCenterUrl +' class="font-highlight close goToDownloadCenter">', 'aright':'</a>'})+'&nbsp;</div>');
            $('.goToDownloadCenter').on('click',function(){
                window.location.href = params.downloadCenterUrl;
            })
            setTimeout(function(){
            ...
            alert(data['msg']);
            inst.removeClass('export-icon-load');
            //inst.after('<div class="tip-export"><a class="fr close font-highlight">çŸ¥é“äº†<b class="icon icon-close"></b></a>è¯·å‰å¾€<a href="/apps/download_center" class="font-highlight close">æŠ¥è¡¨ä¸­å¿ƒ</a></div>');
        }
...
$('.exportCsv').bind('click',function(e){
    ...
    _gaq.push(['_trackEvent', 'å¯¼å‡ºæŠ¥è¡¨', pageName, tableName]);
})
            ...
            $.each(items, function(i, item) {
                ...
                if($item.attr('data-enable') === 'true') {
                    $item.off().on('click.timeunit', function(e) {
                        _track_userEvent('æ–°åŠŸèƒ½ç›‘æµ‹_æ—¶é—´é¢—ç²’åº¦', $item.data('unit'), UMENG.Agent.getDate().counts);
...
var umengAdsBar = function(){
    ...
    this.showbar = function(params,adsId){
        ...
        if(params.link){
            ...
            $('#hellobar span').append('<a href="' + params.link + '" target="_blank">äº†è§£æ›´å¤š</a>');
        }else{
            $('#hellobar span').text(params.content);
        }
        if(params.id != adsId){
        ...
        bindEvent: function () {
            ...
            this.element.find('.multi-selector-submit').click(function () {
                ...
                if(self.getCustomData().length === 0 && self.selectedSection === 'custom') {
                    alert(I18n.t('page_misc.retention.no_custom_info') + self.options.name + "ï¼", 3000);
                    return false;
                }
